...
if($check >= 1){
echo '<div class="alert alert-danger alert-dismissible bg-primary text-white border-0 fade show" role="alert">Tài khoản đã tồn tại trên hệ thống!</div>';
} else {
...
echo '<div class="alert alert-success alert-dismissible bg-primary text-white border-0 fade show" role="alert">Đăng bán tài khoản thành công</div>';
