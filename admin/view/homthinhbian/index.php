...
echo '<div class="alert alert-success fade in alert-dismissible">
    ...
    <strong>Success!</strong> Đăng bán Hòm Tiếp Tế thành công
</div>';
...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Đăng Bán Hòm Tiếp Tế</h3>
...
<div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-4 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                     <input name="kimcuong" type="text" class="form-control" placeholder="Nhập Số Kim Cương Xuất Hiện Trong Hòm">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-12"> 
                                <center><button type="submit" name="submit" class="btn btn-info">ĐĂNG BÁN HÒM TIẾP TẾ</button></center>
                            </div>
...
<div class="row">
                    <div class="col-lg-6 col-xs-12 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Hòm Tiếp Tế ĐANG BÁN</h3>
...
?>
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title">Hòm Tiếp Tế ĐÃ BÁN</h3>
...
function del(id, name) {
     if (confirm('Bạn có chắc muốn xóa Hòm Tiếp Tế này?')) {
