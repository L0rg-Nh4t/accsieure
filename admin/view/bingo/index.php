...
<h2><b>Chỉnh sửa tỉ lệ bingo</b></h2><br>
    ...
    <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nổ Hũ Kim Cương (Từ):</h4>
                                    <div class="form-group">
                                        <input name="nohu_from" type="text" value="<?php echo $nohu_from;?>" class="form-control" placeholder="Nổ Hũ Kim Cương (Từ):">
                                                                      </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nổ Hũ Kim Cương (Đến):</h4>
                                    <div class="form-group">
                                        <input name="nohu_to" type="text" value="<?php echo $nohu_to;?>" class="form-control" placeholder="Nổ Hũ Kim Cương (Đến):">
                                                                      </div>
                            </div>
                        </div>
                    </div>
