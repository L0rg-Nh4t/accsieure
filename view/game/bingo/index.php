...
<?php if($kun->is_mobile())$cao='215';else $cao='400';?>
    ...
    <div class="col-lg-4 col-xs-4 col-md-4"><img id="role_1" style="width: 100%;" src="/assets_2/img/bingo/bingo_minc.gif"></div>
    <div class="col-lg-4 col-xs-4 col-md-4"><img id="role_2" style="width: 100%;" src="/assets_2/img/bingo/bingo_minc.gif"></div>
    <div class="col-lg-4 col-xs-4 col-md-4"><img id="role_3" style="width: 100%;" src="/assets_2/img/bingo/bingo_minc.gif"></div>
...
<div class="col-lg-6 col-md-6 col-xs-12 list-roll text-center">
    <div class="btn-top" style="margin-top: 30px;">
...
function change_img(id, img_name) {
        ...
        roll.src = "";
        roll.src = '/assets_2/img/bingo/'+img_name+'.gif';
}
