...
<div class="c-content-title-1">
            ...
            <div class="col-md-8 col-lg-8 col-xs-12 hidden-lg hidden-md">
                  <iframe width="100%" height="230" src="<?php echo $_banner['url'];?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                </div>  
...
<o id="result"><div class="alert alert-info">Nhập chính xác thông tin thẻ!</div></o>
    ...
    <div class="form-group c-margin-t-0">
        <div class="col-md-12">
            <button style="background: -webkit-linear-gradient(bottom, #FFE900 0%, #F2AC00 100%)!important;border-radius: 8px;color: #000;" type="submit" name="submit" class="btn btn-submit c-theme-btn c-btn-square c-btn-uppercase c-btn-bold btn-block" data-loading-text="<i class='fa fa-spinner fa-spin '></i>">NẠP THẺ
            </button>
  ...
  <div class="c-content-box">
		<div id="slider" class="owl-theme section section-cate slideshow_full_width ">
			<div id="slide_banner" class="owl-carousel">
			 	...
			 	<img src="<?php echo $_banner['url'];?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		 		</div>	 		
