<?php 
if($kun->check_user_nhan_qua() == false) {
    if($title != 'Đăng Nhập' && $title != 'Đăng Kí') {
     // Require Quà Đăng Kí
    require $_SERVER['DOCUMENT_ROOT'].'/view/Widget/qua_dangki.php';        
    }
}
?>
...
<footer class="c-layout-footer c-layout-footer-3 c-bg-dark" style="background: linear-gradient(rgb(0 0 0 / 14%), hsl(0deg 0% 0%)),url(https://i.imgur.com/GJgYIPl.jpg) no-repeat center top;
    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-6">
                ...
                <p><strong>Thời gian làm việc: 7h Sáng- 18h chiều các ngày trong tuần</strong></p>
                <hr/>
				<p><strong>➽ Địa Chỉ Chủ Shop: 68 Lê Đình Lý - P.Vĩnh Trùng - Q.Thanh Khê - Đà Nẵng</strong></p>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6">
                ...
                <hr/>
				<p><strong>
					<i class="fa fa-history"></i> Giao Dịch Thành Công: <font color="orange">+783.235</font> Giao Dịch
				</strong></p>
				<p><strong>
					<i class="© 2020"></i>© 2020 <?php echo $_title['name'];?>, <font color="orange"> Phúc NG</font> (WIKI)
				</strong></p>
...
<!-- Load Facebook SDK for JavaScript -->
      ...
      <div class="fb-customerchat"
        ...
        page_id="107243794488095"
  theme_color="#0084ff"
  logged_in_greeting="Chào Bạn! Bác Gấu Có Thể Giúp Được Gì Cho Bạn Không ?"
  logged_out_greeting="Chào Bạn! Bác Gấu Có Thể Giúp Được Gì Cho Bạn Không ?">
      </div>
