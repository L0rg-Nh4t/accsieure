...
<script type="application/ld+json">
    ...
    <script src="/assets/frontend/plugins/Inputmask/jquery.inputmask.bundle.js" type="text/javascript"></script>
    ...
    <style type="text/css">
        body{
            background: #000;
            background: url("https://i.imgur.com/MOlUw5Q.jpg");
    ...
    <audio autoplay >
  <source src="<?php echo $_admin['youtube'];?>"" type="audio/mpeg">
</audio>
                ...
                <div class="c-navbar-wrapper clearfix">
                    <div class="c-brand c-pull-left">
                        <a href="/" class="c-logo">
                            ...
                            <img src="<?php echo $_logo['url'];?>" alt="" style="height: <?php echo $_logo['height'];?>px; width: <?php echo $_logo['width'];?>px;" class="c-mobile-logo">
                        </a>
                        ...
                        <?php
                        if(!$token && $title != 'Đăng Nhập') { ?> 
                        <a style="margin-right: 15px;margin-top: -3px;border-radius: 7px;background: -webkit-linear-gradient(bottom, #FFE900 0%, #F2AC00 100%)!important;color: #000;" class="btn btn-submit c-theme-btn c-btn-square c-btn-uppercase c-btn-bold pull-right hidden-lg" href="/signin.html"><i class="icon-user"></i>Đăng Nhập</a>
                        <?php }else { ?>
                        <a style="margin-right: 15px;margin-top: -3px;font-size: 13px;border-radius: 7px;background: -webkit-linear-gradient(bottom, #FFE900 0%, #F2AC00 100%)!important;color: #000;" class="btn btn-submit c-theme-btn c-btn-square c-btn-uppercase c-btn-bold pull-right hidden-lg" href="/user/thongtin"><?php echo $user['name'];?> - <o id="mobile_money"><?php echo number_format($user['money']);?></o>đ</a>          
                        <?php } ?>
                    ...
                    <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold" <?php if($kun->is_mobile()) { ?>style="margin-top: -16;"<?php } ?>>
                        <ul class="sa-menu nav navbar-nav c-theme-nav">
