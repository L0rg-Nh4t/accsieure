...
<div class="modal-header">
    ...
    <h4 class="modal-title">Xác nhận mua Hòm Tiếp Tế</h4>
</div>
                <div class="modal-body" id="buy">
                    <p style="display: none;" id="result"></p>
				<table class="table table-striped">
					<tbody><tr>
						<th colspan="2">Xác nhận mua Hòm Tiếp Tế mã số #<?php echo $row['id'];?></th>
					</tr>
						<tr>
							<td>Nhà phát hành:</td>
						...
						<tr>
							<td>Loại:</td>
							<th class="text-danger">Hòm Tiếp Tế</th>
						</tr>
						<tr>
							<td>Giá tiền:</td>
